...
DEFAULT_COLUMN_LABELS = {
    ...
    "col_students":  "الطلاب",
    "col_classes":   "الفصول",
    "col_density":   "الكثافة (Density) ≥24",
    "col_teachers":  "المعلمين",
    "col_CCR":       "معدل استغلال الفصول (CCR) ≥14",
    "col_admins":    "الإداريين",
    "col_STR":       "نسبة الطلاب للمعلمين (STR) ≥50",
    "col_support":   "الخدمات",
    "col_SAR":       "نسبة الطلاب للإداريين (SAR) ≥90",
    "col_staff":     "الكوادر",
    "col_SSR":       "نسبة الخدمات المساندة (SSR)",
